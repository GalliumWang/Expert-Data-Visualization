function show() {
    ...
    function update(year) {
        ...
        // console.log(Math.max(maxAbove, maxBelow));
    ...
    function addAxis(yIncomeScale, yIndexedScale, xScale, xRangeAdjusted) {
        ...
        bottomAxisChart.selectAll('text')
            .attr("transform", "translate(-6 14) rotate(-45)");
    }
    ...
    function addMouseTracker(xScale, yIndexedScale, yIncomeScale, adjustedIndexedData, unadjustedCleaned) {
        ...
        function mousemove() {
            ...
            focus.select("#indexText")
                .attr("transform", "translate(" + xPos + "," + (yIndexPos + textOffset) + ")")
                .text(Math.round((d.indexed-100)*100)/100).attr("text-anchor", "middle");
            focus.select("#incomeText")
                .attr("transform", "translate(" + xPos + "," + (yIncomePos - textOffset) + ")")
                .text("$ " + dIncome.value).attr("text-anchor", "middle");
